...
public class SignInCounsellor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sign_in_counsellor);
    ...
    //it allows the counsellor to sign in if their username and password are correct
    //error messages pop up as required
    public void CounsellorSign(View view) {
        ...
        req.doRequestWithParameters(SignInCounsellor.this,
                    ...
                    public void processResponse(String response) {
                        try {
                            ...
                            if(processCounsellorSignInJSON(response, enteredUsername, enteredPassword)){
                                ...
                                Intent i = new Intent(SignInCounsellor.this, PatientList.class);
                                i.putExtra("username", enteredUsername);
                                SignInCounsellor.this.startActivity(i);
    ...
    public Boolean processCounsellorSignInJSON(String json, String enteredUsername, String enteredPassword) throws JSONException {
        ...
        String databasePassword = jo.getString("COUNSELLOR_PASSWORD");
    ...
    public void SignUp(View view) {
        Intent i = new Intent(this, SignUpCounsellor.class);
